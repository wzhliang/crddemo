...
import (
	...
	scheme "github.com/wzhliang/crddemo/pkg/client/clientset/versioned/scheme"
...
type StackInterface interface {
	...
	Get(name string, options meta_v1.GetOptions) (*v1.Stack, error)
	List(opts meta_v1.ListOptions) (*v1.StackList, error)
...
func newStacks(c *WseV1Client, namespace string) *stacks {
	return &stacks{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *stacks) Get(name string, options meta_v1.GetOptions) (result *v1.Stack, err error) {
	result = &v1.Stack{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("stacks").
...
func (c *stacks) List(opts meta_v1.ListOptions) (result *v1.StackList, err error) {
	result = &v1.StackList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("stacks").
...
func (c *stacks) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("stacks").
...
func (c *stacks) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *stacks) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("stacks").
